...
plot(xTarget1, yTarget1, 'go', 'MarkerSize',3, 'MarkerFaceColor','g');
plot(xTarget2, yTarget2, 'go', 'MarkerSize',3, 'MarkerFaceColor','g');
plot(xTarget3, yTarget3, 'go', 'MarkerSize',3, 'MarkerFaceColor','g');

xcircle1 = thresh * cos(th) + xTarget1;
ycircle1 = thresh * sin(th) + yTarget1;
h = plot(xcircle1, ycircle1, 'Color','g');

xcircle2 = thresh * cos(th) + xTarget2;
ycircle2 = thresh * sin(th) + yTarget2;
h = plot(xcircle2, ycircle2, 'Color','g');


xcircle3 = thresh * cos(th) + xTarget3;
ycircle3 = thresh * sin(th) + yTarget3;
h = plot(xcircle3, ycircle3, 'Color','g');
