function [xMiddle,yMiddle,phiMiddle,totalTime] = RBR(xNear,yNear,phiNear,xNew,yNew,phiNew,maxSpeed)
...
phiNew_relative1 = rem(phiNew_relative1,2*pi);
...
phiNew_relative2 = rem(phiNew_relative2,2*pi);
